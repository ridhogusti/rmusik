@extends('layouts.app') @section('content') @guest @else
                      ...
                      @foreach(array_slice($rekomendasi->toArray(), $loop, 6) as $item)
                        <div class="col-xs-4 col-md-2">
                          ...
                          <blockquote class="f-15 f-raleway no-pad-top no-pad-bot pad-left-5 no-pad-right ">
                            {{ $item['title'] }} <br> {{ $item['artist'] }} <br> {{ $item['root_genre'] }} <br> 
                        ...
                        {{-- <div class="col-md-3"><a href="#" class="thumbnail"><img src="{{ $item['imUrl'] }}" alt="Image" style="max-width:100%;"></a></div> --}}
                      @endforeach
                    </div><!--.row-->
                  </div>   
                  <?php
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 no-pad-left mar-top-10">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f-raleway f-13 no-padding color-white hide-bg-abu hide-bor-bot">
                  ...
                  @guest
                  {{-- <p>
                    <input id="input-id" disabled name="rating" type="number" value="0" class="rating" min=0 max=5 step=1 data-size="medium" data-rtl="false">
                  </p> --}}
                  @else
                  <?php
                  ...
                  ?>
                    @if($collection->count() == null)
                      <input id="input-id" name="rating" disabled type="number" value="0" class="rating" min=0 max=5 step=1 data-size="medium" data-rtl="false">
                    @else
                      <p>
                        <input id="input-id" name="rating" disabled type="number" value="{{ $collection[0]->rating }}" class="rating" min=0 max=5 step=1 data-size="medium" data-rtl="false">
                      </p>   
                    @endif
            ...
            <div class="rows">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding color-white mar-top-10 text-center f-15">
                <div class="padding bor-dash-top bor-color-white col-lg-offset-4 col-md-offset-4 col-sm-offset-3 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  Tampilkan Lebih Banyak<br> {{-- <button id="btn-more" data-id="{{ $itemm->id }}" class="nounderline btn-block mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"> Load More </button>                  --}}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding mar-top-10 ">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 f-raleway f-13 no-padding color-white hide-bg-gray hide-bor-bot">
                ...
                @guest
                  ...
                  ?>
                    @if($collection->count() == null)
                      <input id="input-id" disabled name="rating" disable="true" type="number" value="0" class="rating" min=0 max=5 step=1 data-size="medium" data-rtl="false">
                    @else
                      <p>
                        <input id="input-id" disabled name="rating" disable type="number" value="{{ $collection[0]->rating }}" class="rating" min=0 max=5 step=1 data-size="medium" data-rtl="false">
                      </p>   
                    @endif
                  @endguest
              </div>
